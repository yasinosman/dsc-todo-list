...
class Datetime {
  ...
  initDateTime() {
    ...
    this.render(currentDatetime); //Her saniye fonksiyonu recursive olarak çağır, bu sayede saat sürekli olarak güncellenecek
...
class Header {
  constructor() {
    ...
    new _Datetime.default(); //Temizle butonu için gerekli event listener'ın eklenmesi
...
},{"./Datetime":"components/Datetime.js"}],"components/Todo.js":[function(require,module,exports) {
"use strict";
...
class TodoList {
  ...
  setupTodos() {
    if (this.todos !== null && this.todos.length > 0) {
      ...
      this.todos.forEach(to_do => {
        new _Todo.default(to_do.todo, to_do.isComplete, to_do.id);
      });
    }
  ...
  toggleTodo(todoId) {
    ...
    this.todos = this.todos.map(todo => todo.id === todoId ? { ...todo,
      isComplete: !todo.isComplete
    } : todo); //Değişiklikleri localStorage'a kaydet

    this.saveTodos(); //Uygulama durumunu güncelle
  ...
  deleteTodo(todoId) {
    //TodoList instance'ını güncelle
    this.todos = this.todos.filter(todo => todo.id !== todoId); //Değişiklikleri local storage'a kaydet
  ...
  handleAddTodoEvent(e) {
    ...
    if (e.keyCode === 13) {
      ...
      if (e.target.value !== "") {
        ...
        this.addTodo(newTodo); //Formu sıfırla
  ...
  addTodo(todo) {
    ...
    this.todos.push(todo); //Yapılacakları localStorage'a kaydet
...
},{"uuid":"node_modules/uuid/dist/esm-browser/index.js","./Header":"components/Header.js","./Todo":"components/Todo.js"}],"app.js":[function(require,module,exports) {
"use strict";
...
const app = () => {
  return new _TodoList.default();
};

app();
},{"./components/TodoList":"components/TodoList.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
